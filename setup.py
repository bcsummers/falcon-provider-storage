# -*- coding: utf-8 -*-
"""Setup for falcon-provider-storage package."""
# standard library
import os
...
metadata_file: str = os.path.join(
    os.path.abspath(os.path.dirname(__file__)), 'falcon_provider_storage', '__metadata__.py'
)
...
setup(
    ...
    project_urls={
        'Documentation': 'https://github.com/bcsummers/falcon-provider-storage/',
        'Source': 'https://github.com/bcsummers/falcon-provider-storage/',
    },
    python_requires='>=3.6',
    scripts=[],
    test_suite='tests',
