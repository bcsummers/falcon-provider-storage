...
def test_local_delete(client_local_storage_1, storage_directory) -> None:
    ...
    response: Result = client_local_storage_1.simulate_delete('/middleware', params=params)
...
def test_local_delete_404(client_local_storage_1, storage_directory) -> None:
    """Testing DELETE resource
...
def test_local_file_exists(client_local_storage_1, storage_directory) -> None:
    ...
    response: Result = client_local_storage_1.simulate_get('/middleware', params=params)
    assert response.status_code == 200
    assert response.text == key


def test_local_does_not_exists(client_local_storage_1) -> None:
    """Testing GET resource
...
def test_local_file_upload(client_local_storage_1, storage_directory) -> None:
...
def test_bad_directory() -> None:
    ...
    if passed:
        assert False, 'Bad bucket/path not caught'
